...
export default function InquireButton() {
    ...
    return (
            <div className="flex justify-center">
                <button className="download-button transform active:scale-95 bg-lime-500 hover:bg-lime-600 text-white px-5 py-6 rounded-lg font-bold tracking-widest w-full">
                    <div className="flex justify-center items-center relative">
                        ...
                        <div className="button-copy pl-2 leading-none uppercase">Inquire now</div>
                    </div>
                </button>
            </div>
    );
